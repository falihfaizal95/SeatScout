      ...
      <div className="w-full max-w-md">
        <div className="bg-[var(--bg-secondary)] rounded-3xl border border-[var(--border)] p-8 shadow-soft">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-[var(--text-muted)]">Sign in to your SeatScout account</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-[var(--border)] bg-[var(--bg-primary)] text-[var(--text-primary)] placeholder:text-[var(--text-muted)] text-sm outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-400/20 transition-all"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold text-[var(--text-secondary)] mb-1.5">
            ...
            <p className="text-center text-xs text-[var(--text-muted)]">
              ...
              <Link href="/sign-up" className="text-brand-500 hover:text-brand-700 font-semibold">
                Create one
              </Link>
            </p>
          </div>
