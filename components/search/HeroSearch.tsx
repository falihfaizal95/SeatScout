        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col gap-3 md:flex-row">
            ...
            <button
              ...
              className="h-16 rounded-2xl bg-green-500 px-10 text-lg font-semibold text-white transition-colors hover:bg-green-600 disabled:cursor-not-allowed disabled:opacity-40 md:min-w-[240px]"
            >
              Search Deals
            </button>
          </div>
